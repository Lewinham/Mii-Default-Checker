...
### 3. Run the code and input the slider values for your mii.
...
while quit_program == False:
    ...
    except ZeroDivisionError as no_valid_inputs:
        print("Error\nYou did not enter any valid inputs.")

    rerun = input("_________________________________\nPress \"a\" + \"Enter\" to evaluate another mii.\nPress any other key to close the program.")
    if rerun == "a":
        quit_program = False
    else:
        quit_program = True
